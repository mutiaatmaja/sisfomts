        ...
        <div id="tableCustomBasic" class="col-lg-12 col-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    ...
                    @endif
                    <form action="{{ isset($pesertaDidik) ? route('pesertadidik.update', $pesertaDidik->uuid) : route('pesertadidik.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-12 mb-3 d-flex flex-column align-items-center justify-content-start">
                                ...
                                <video id="video-capture" width="240" height="240" autoplay style="display:none; border-radius:8px; object-fit:cover; margin-bottom:8px;"></video>
                                <canvas id="canvas-capture" width="240" height="240" style="display:none;"></canvas>
                                <button type="button" id="btn-capture" class="btn btn-success btn-block mb-1" style="display:none;" onclick="captureFoto()">Ambil Foto</button>
                                <button type="button" id="btn-cancel-capture" class="btn btn-danger btn-block" style="display:none;" onclick="cancelCapture()">Batal</button>
                            </div>
                            <!-- Form di kanan -->
                    ...
                    <script>
                        ...
                        function ambilGambar() {
                            ...
                            if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
                                navigator.mediaDevices.getUserMedia({ video: { width: 240, height: 240 } }).then(function(stream) {
