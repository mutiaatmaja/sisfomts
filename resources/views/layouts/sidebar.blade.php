        ...
        <div class="navbar-nav theme-brand flex-row  text-center">
            <div class="nav-logo">
                <div class="nav-item theme-logo">
                    <a href="index.html">
                        <img src="src/assets/img/g-8.png" class="navbar-logo" alt="logo">
                    </a>
                </div>
        ...
        <div class="profile-info">
            <div class="user-info">
                <div class="profile-img">
                    <img src="layouts/src/assets/img/profile-30.png" alt="avatar">
                </div>
                <div class="profile-content">
                    <h6 class="">{{ auth()->user()->name ?? 'Tamu' }}</h6>
                    <p class="">Sistem Informasi</p>
                </div>
            </div>
        </div>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{ request()->is('/') ? 'active' : '' }}">
                <a href="/" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2V12H9v8a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2z"/></svg>
                        <span>Beranda</span>
                    </div>
                </a>
            </li>
            ...
            <li class="menu {{ request()->is('informasi-sekolah') ? 'active' : '' }}">
                <a href="/informasi-sekolah" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-info"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12" y2="8"/></svg>
            ...
            <li class="menu {{ request()->is('absensi-siswa') ? 'active' : '' }}">
                <a href="/absensi-siswa" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu {{ request()->is('pendidik-tendik') ? 'active' : '' }}">
                <a href="/pendidik-tendik" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-briefcase"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 3H8v4h8V3z"/></svg>
            ...
            <li class="menu {{ request()->is('sarana-prasarana') ? 'active' : '' }}">
                <a href="/sarana-prasarana" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M21 16V8a2 2 0 0 0-1-1.73L13 2.27a2 2 0 0 0-2 0L4 6.27A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4a2 2 0 0 0 1-1.73z"/></svg>
            ...
            <li class="menu {{ request()->is('prestasi') ? 'active' : '' }}">
                <a href="/prestasi" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-star"><polygon points="12 2 15 8.5 22 9.3 17 14 18.5 21 12 17.7 5.5 21 7 14 2 9.3 9 8.5 12 2"/></svg>
                        <span>Prestasi</span>
                    </div>
                </a>
            </li>
                ...
                <a href="/admin/logs" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" ...> <!-- ikon file-text -->
                            <path d="M9 12h6M9 16h6M5 8h14M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h6l2 2h6a2 2 0 012 2v10a2 2 0 01-2 2z"/>
                        </svg>
