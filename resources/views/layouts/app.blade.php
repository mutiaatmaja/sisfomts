...
<body class="layout-boxed">
                                ...
                                <div class="widget-content">
                                    <div class="account-box">
                                        ...
                                        <div class="info-box">
                                            <div class="icon">
                                                <span>
                                                    <img src="layouts/src/assets/img/money-bag.png" alt="money-bag">
                                                </span>
                                            </div>
                                                ...
                                                <div class="w-browser-stats">
                                                    <div class="progress">
                                                        <div class="progress-bar bg-gradient-primary"
                                                            role="progressbar" style="width: 65%" aria-valuenow="90"
                                                ...
                                                <div class="w-browser-stats">
                                                    <div class="progress">
                                                        <div class="progress-bar bg-gradient-danger"
                                                            role="progressbar" style="width: 35%" aria-valuenow="65"
                                                            aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="meta-info">
                                        ...
                                        <div class="avatar--group">
                                            ...
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="layouts/src/assets/img/profile-8.jpg" />
                                            </div>
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="layouts/src/assets/img/profile-12.jpg" />
                                            </div>
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="layouts/src/assets/img/profile-19.jpg" />
                                            </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-card-one">
                                <div class="widget-content">
                                    ...
                                    <div class="media">
                                        <div class="w-img">
                                            <img src="layouts/src/assets/img/profile-19.jpg" alt="avatar">
                                        </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-card-two">
                                <div class="widget-content">
                                    ...
                                    <div class="media">
                                        <div class="w-img">
                                            <img src="layouts/src/assets/img/g-8.png" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="card-bottom-section">
                                        ...
                                        <div class="img-group">
                                            <img src="layouts/src/assets/img/profile-19.jpg" alt="avatar">
                                            <img src="layouts/src/assets/img/profile-6.jpg" alt="avatar">
                                            <img src="layouts/src/assets/img/profile-8.jpg" alt="avatar">
                                            <img src="layouts/src/assets/img/profile-3.jpg" alt="avatar">
                                        </div>
    ...
    <script src="layouts/src/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="layouts/src/plugins/src/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    <script src="layouts/src/plugins/src/mousetrap/mousetrap.min.js"></script>
    <script src="layouts/src/plugins/src/waves/waves.min.js"></script>
