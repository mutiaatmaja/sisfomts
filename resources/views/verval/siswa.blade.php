...
<head>
    ...
    <title>Verivikasi Data Siswa </title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('html/src/assets/css/light/elements/alert.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('html/src/assets/css/dark/elements/alert.css') }}">
